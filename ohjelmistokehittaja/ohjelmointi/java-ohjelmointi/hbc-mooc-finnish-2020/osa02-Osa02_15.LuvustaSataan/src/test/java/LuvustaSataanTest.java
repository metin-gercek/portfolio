...
@Points("02-15")
public class LuvustaSataanTest {
    ...
    @Test(timeout = 1000)
    public void test1() {
        testaaTulostusJarjestyksessa("99\n", "99\n100\n", "\\s*99\\s*100\\s*", "98", "101");
    }

    @Test(timeout = 1000)
    public void test2() {
        testaaTulostusJarjestyksessa("-3\n", "3-\n-2\n...monta lukua...\n98\n99\n100\n", "\\s*-3\\s*-2\\s*-1\\s*[0-98\\s]*\\s*99\\s*100\\s*", "-4", "101");
    }
    ...
    public void testaa(String syote, String odotettu, String... eiOdotetut) {
        ...
        io.setSysIn(syote);
        callMain(LuvustaSataanTest.class);
