...
@Points("02-11")
public class LukumaaraJaSummaTest {
    ...
    public void testaa(int... luvut) {
        ...
        io.setSysIn(syote);
        callMain(LukumaaraJaSumma.class);
        ...
        int lukuja = syotaOdotettu - 1;
        String yhtOdotettu = "Lukuja yhteensä " + lukuja;
        assertTrue("Kun syötettiin:\n" + syote + "\nOhjelmassa pitäisi olla tulostus \"" + yhtOdotettu + "\".\nNyt tulostus oli" + out, out.contains(yhtOdotettu));
        ...
        for (int i = 0; i < 100; i++) {
            ...
            String eiOdotettu = "Lukuja yhteensä " + i;
            assertFalse("Kun syötettiin:\n" + syote + "\nOhjelmassa ei pitäisi olla tulostusta \"" + eiOdotettu + "\".\nNyt tulostus oli " + out, out.contains(eiOdotettu));
        }
    }
