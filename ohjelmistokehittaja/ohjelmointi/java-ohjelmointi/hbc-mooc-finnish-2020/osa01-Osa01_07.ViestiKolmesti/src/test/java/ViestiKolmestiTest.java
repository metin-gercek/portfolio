...
@Points("01-07")
public class ViestiKolmestiTest {

    @Rule
    public MockStdio io = new MockStdio();

    @Test
    public void heippaTulostusOikein() {
        tulostusOikein("Heippa");
    }

    @Test
    public void olipaKerranTulostusOikein() {
        tulostusOikein("Olipa kerran...");
    }

    private void tulostusOikein(String syote) {
        io.setSysIn("" + syote + "\n");
        ViestiKolmesti.main(new String[]{});
        String[] lines = new String[]{"Kirjoita merkkijono!", syote, syote, syote};
