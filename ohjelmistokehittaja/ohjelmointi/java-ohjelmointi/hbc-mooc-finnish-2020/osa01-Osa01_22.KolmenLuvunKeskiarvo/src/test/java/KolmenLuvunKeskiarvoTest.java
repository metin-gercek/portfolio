...
public class KolmenLuvunKeskiarvoTest {
    ...
    public void tulostusOikeinEkalleEsimerkille() {
        tulostusOikein("8", "2", "3");
    }

    @Test
    public void tulostusOikeinTokalleEsimerkille() {
        tulostusOikein("9", "5", "-1");
    }

    private void tulostusOikein(String eka, String toka, String kolmas) {
        String syote = eka + "\n" + toka + "\n" + kolmas + "\n";
        io.setSysIn(syote);
        KolmenLuvunKeskiarvo.main(new String[]{});
        String[] lines = new String[]{"Syötä ensimmäinen luku!",
            "Syötä toinen luku!",
            "Syötä kolmas luku!",
            "Syötettyjen lukujen keskiarvo on " + (1.0 * Integer.valueOf(eka) + Integer.valueOf(toka) + Integer.valueOf(kolmas)) / 3
        };
    ...
    public void jarjestysOikein() {
        List<String> koodi = koodi("KolmenLuvunKeskiarvo.java");
