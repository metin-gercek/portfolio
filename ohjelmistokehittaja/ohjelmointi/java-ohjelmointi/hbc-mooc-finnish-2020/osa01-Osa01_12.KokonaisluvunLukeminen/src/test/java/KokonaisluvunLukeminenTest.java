...
@Points("01-12")
public class KokonaisluvunLukeminenTest {

    @Rule
    public MockStdio io = new MockStdio();

    @Test
    public void tulostusOikeinKunLuku8() {
        tulostusOikein("8");
    }

    @Test
    public void tulostusOikeinKunLuku300() {
        tulostusOikein("300");
    }
    ...
    public void syoteMuunnetaanLuvuksi() {
        try {
            ...
            fail("Ohjelman tulee muuntaa syötetty luku kokonaisluvuksi. Nyt muunnosta ei tapahdu.");
    ...
    private void tulostusOikein(String luku) {
        io.setSysIn(luku + "\n");
        KokonaisluvunLukeminen.main(new String[]{});
    ...
    public void jarjestysOikein() {
        List<String> koodi = koodi("KokonaisluvunLukeminen.java");
        int lkm = laskeEsiintymat(koodi, "System.out.println.*Integer.*System.out.println");
        int lkm2 = laskeEsiintymat(koodi, "System.out.println.*parseInt.*System.out.println");
