...
@Points("01-17")
public class KahdenLuvunSummaTest {
    ...
    private void tulostusOikein(String eka, String toka) {
        String syote = eka + "\n" + toka + "\n";
        io.setSysIn(syote);
        KahdenLuvunSumma.main(new String[]{});
        String[] lines = new String[]{"Syötä ensimmäinen luku!",
            "Syötä toinen luku!",
            "Lukujen summa on " + (Integer.valueOf(eka) + Integer.valueOf(toka))
        };
    ...
    public void jarjestysOikein() {
        List<String> koodi = koodi("KahdenLuvunSumma.java");
        int lkm = laskeEsiintymat(koodi, "System.out.println.*Integer.*System.out.println.*Integer.*System.out.println");
        int lkm2 = laskeEsiintymat(koodi, "System.out.println.*nextInt.*System.out.println.*Integer.*System.out.println");
